...
#------------------------------------
    ...
    #--------------------
        ...
        self.hist = (
            ...
            .StrCat(["4j1b"], name="region", label="Region")
...
#	nevts_total = 10000
        ...
        for pt_var in pt_variations:
            ...
            #object filters
            selected_electrons = events.electron[(events.electron.pt > 8) & (abs(events.electron.eta)<2.4) & (events.electron.isLoose == True)]
	   ...
	   # selected_photons= events.photon[()]
