...
#-------------------------------------------------------
    ...
    pseudo_data = (all_histograms[:, :, "ttbar", "nominal"])  + all_histograms[:, :, "wjets", "ME_var"]
        ...
        for region in ["4j1b", "4j2b"]:
            ...
            f[f"{region}_ttbar_ME_var"] = all_histograms[120j::hist.rebin(2), region, "ttbar", "nominal"]
            #f[f"{region}_ttbar_PS_var"] = all_histograms[120j::hist.rebin(2), region, "ttbar", ""]
